...
#define STRING_CONFIG_H_AUTHOR "(K8SRGL, Ender3Pro w/ BTT SKR E3 Turbo)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 99.7 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -9, -3.18 }
